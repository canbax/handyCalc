(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(_ngZone, _clipboardService, _snackBar) {
                    var _this = this;
                    ...
                    this.modelChanged.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["debounceTime"])(300), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["distinctUntilChanged"])())
                        .subscribe(function (x) { _this.inp = x; _this.compute(); });
                    this.isOpen = false;
                }
                AppComponent.prototype.triggerResize = function () {
                    var _this = this;
                ...
                AppComponent.prototype.changed = function (text) {
                ...
                AppComponent.prototype.copy = function (txt) {
                    this._clipboardService.copyFromContent(txt);
                    this.showSnackbar("'" + txt + "' copied!");
                };
                AppComponent.prototype.showSnackbar = function (txt) {
                    this._snackBar.open(txt, 'OK', {
                        duration: 2000
                    });
                };
                AppComponent.prototype.onScreenKeyClicked = function (txt) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var ScreenKeyboardComponent = /** @class */ (function () {
                function ScreenKeyboardComponent() {
                    this.screenKeyClicked = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                    this.tiles = [
                        { txt: 'sin', fn: function (s) { return s + 'sin('; } },
                        { txt: 'cos', fn: function (s) { return s + 'cos('; } },
                        { txt: 'tan', fn: function (s) { return s + 'tan('; } },
                        { txt: 'x<sup>2</sup>', fn: function (s) { return s + '^2'; } },
                        { txt: '&#8730;x', fn: function (s) { return s + '^(0.5)'; } },
                        { txt: '7', fn: function (s) { return s + '7'; } },
                        { txt: '8', fn: function (s) { return s + '8'; } },
                        { txt: '9', fn: function (s) { return s + '9'; } },
                        { txt: 'DEL', fn: function (s) { return s.slice(s.length - 1); } },
                        { txt: 'C', fn: function (s) { return ''; } },
                        { txt: '4', fn: function (s) { return s + '4'; } },
                        { txt: '5', fn: function (s) { return s + '5'; } },
                        { txt: '6', fn: function (s) { return s + '6'; } },
                        { txt: 'x', fn: function (s) { return s + '*'; } },
                        { txt: '÷', fn: function (s) { return s + '÷'; } },
                        { txt: '1', fn: function (s) { return s + '1'; } },
                        { txt: '2', fn: function (s) { return s + '2'; } },
                        { txt: '3', fn: function (s) { return s + '3'; } },
                        { txt: '+', fn: function (s) { return s + '+'; } },
                        { txt: '-', fn: function (s) { return s + '-'; } },
                        { txt: '0', fn: function (s) { return s + '0'; } },
                        { txt: '.', fn: function (s) { return s + '.'; } },
                        { txt: '(', fn: function (s) { return s + '('; } },
                        { txt: ')', fn: function (s) { return s + ')'; } },
                        { txt: '=', fn: function (s) { return s + '='; } }
                ...
                ScreenKeyboardComponent.prototype.ngOnInit = function () {
                };
                ScreenKeyboardComponent.prototype.tileClicked = function (k) {
                    this.screenKeyClicked.emit(k.fn(this.currInp));
                };
                ScreenKeyboardComponent.prototype.simulateKeyDown = function (key) {
                    this.myDiv.nativeElement.querySelector('button').click();
                };
                ScreenKeyboardComponent.prototype.simulateKeyUp = function (key) {
                };
                return ScreenKeyboardComponent;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
